...
{   
    ...
    {
      var reservation = new Reservation({name: req.body.name, seance: req.body.seance, mail: req.body.mail, phone: req.body.phone, rowNumber: x.rowNumber, seatNumber: x.seatNumber});
